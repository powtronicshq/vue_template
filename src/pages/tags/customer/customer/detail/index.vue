<template>
  ...
  <div class='customer-detail'>
    <div>
      ...
      <div style='display:flex;font-size:16px;white-space: nowrap;max-width:970px'>
        <div style='display:flex;'>
          ...
          <p style='overflow: hidden;white-space: nowrap;text-overflow: ellipsis;max-width:470px'>{{customerName}}</p>
        </div>
    ...
    <editCompanyDialog v-if='editCompanyDialogVisible' dialogTitleName='编辑公司信息' titleName='客户' v-model="editCompanyDialogVisible" :defaultKey='customerName' :defaultContact='contact' :defaultContactStyle='contactStyle' :confirm="(customerName,contact,contactStyle)=>{this.sureAddEditCompany(customerName,contact,contactStyle)}"> </editCompanyDialog>
...
export default {
  ...
  methods: {
    ...
    sureAddEditCompany(customerName, contact, contactStyle) {
      this.customerName = customerName // 公司名字
